...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff5e2323),
      surfaceTint: Color(0xff904a48),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa15856),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff4b2f2e),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff876563),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff47330a),
      onTertiary: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff382e2d),
      inversePrimary: Color(0xffffb3af),
      primaryFixed: Color(0xffa15856),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff84413f),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff876563),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff904a48),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff763534),
      onPrimaryContainer: Color(0xffffffff),
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff5c451b),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff5c451b),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xfffad7a0),
      onTertiary: Color(0xff342200),
      tertiaryContainer: Color(0xffa98c5b),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffdfbe89),
