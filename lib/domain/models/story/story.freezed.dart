...
/// e.g. 'story-FvU4u0Vp2S3PMsFg'
 String get id;/// e.g. 'Dimas'
 String get name;/// e.g. 'Lorem Ipsum'
 String get description;/// e.g. 'https://story-api.dicoding.dev/images/stories/photos-1641623658595_dummy-pic.png'
 String get photoUrl;/// e.g. '2022-01-01T00:00:00.000Z'
 DateTime get createdAt;/// e.g. 12.5
 double? get lat;/// e.g. 12.5
 double? get lon;
...
class _Story implements Story {
  const _Story({required this.id, required this.name, required this.description, required this.photoUrl, required this.createdAt, required this.lat, required this.lon});
